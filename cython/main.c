...
static const char __pyx_k_Testing_Print_in_CMD[] = "Testing Print in CMD";
static PyObject *__pyx_kp_s_Testing_Print_in_CMD;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_Testing_Print_in_CMD, __pyx_k_Testing_Print_in_CMD, sizeof(__pyx_k_Testing_Print_in_CMD), 0, 0, 1, 0},
...
if (!__Pyx_RefNanny) {
  ...
  /* "main.pyx":1
 * print('Testing Print in CMD')             # <<<<<<<<<<<<<<
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_Testing_Print_in_CMD) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
